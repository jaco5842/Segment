...
JOIN (
    ...
    FROM [PW-BC].[dbo].[Philipson Wine$Sales Invoice Line]
    GROUP BY [Document No_]
) AS totalAmount
ON totalAmount.[Document No_] = header.[No_]
JOIN [PW-BC].[dbo].[Philipson Wine$Sales Invoice Header$19da28b2-7d51-49e6-8304-0f8b850a7da4] AS web
...
WHERE
    ...
    AND header.[Sell-to Customer No_] NOT IN ('117254', '70226888', '28331843', 'GAVEKORT', '70226888Z', 'BUTIK117254')
GROUP BY
